...
let name2 = ["Pig", "Pancakes", "Doggo", "Whale", "Fish", "Banana", "Mike", "Butterfly", "Scallop", "Duck", "Goose", "Bean", "Tortilla", "Flower", "Biker", "Blade", "Kitty", "Shepard", "Cow", "Rockstar", "Avocado", "Broccoli", "Doggy", "Kitty", "Muffin", "Mango", "Lemon", "Cabbage", "Sponge", "Plant", "Chopstick", "Violin", "Dunky", "Donut", "Raisin", "Loaf", "Man", "Lady", "Burger", "Worm", "Sneaker", "Kirby", "Broccoli", "Cereal", "Pebble", "Stick", "Freddy", "Mouse", "Noodle", "Pickle", "Panda", "Burger", "Egg", "Lotion", "Toast", "Pickle", "Panda"]
